...
import (
	...
	v1alpha1 "github.com/alexgmm/learn-bazel/go/kube-cli/pkg/api/statectl/v1alpha1"
	scheme "github.com/alexgmm/learn-bazel/go/kube-cli/pkg/client/versioned/scheme"
...
func newInstances(c *SamplecontrollerV1alpha1Client, namespace string) *instances {
	return &instances{
		client: c.RESTClient(),
		ns:     namespace,
	}

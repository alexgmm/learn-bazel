...
import (
	...
	"github.com/alexgmm/learn-bazel/go/kube-cli/pkg/client/versioned/scheme"
...
func (c *SamplecontrollerV1alpha1Client) Instances(namespace string) InstanceInterface {
